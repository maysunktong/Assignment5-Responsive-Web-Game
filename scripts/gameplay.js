...
async function init() {
  ...
  collectibles = [
    ...
    new Collectible({
      ...
      velocity: { x: 0, y: 0 },
      image: objects.collectibles.ruby,
      value: 50,
      type: "ruby",
    }),
    new Collectible({
